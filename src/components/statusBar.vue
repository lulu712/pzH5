<template>
    <div class="od-banner">
      <img class="od-banner-icon" src="/image/od_bg_icon.png" mode="widthFix" />
      <div class="od-jd" :class="[`od-jd-${item}`]">
        ...
        <div class="vp-flex od-jd-text">
          <div class="vp-flex_1">
            <text class="od-jd-st-0">填寫訂單</text>
          </div>
          <div class="vp-flex_1">
            <text class="od-jd-st-10">在線支付</text>
          </div>
          <div class="vp-flex_1">
            <text class="od-jd-st-20">專人服務</text>
          </div>
          <div class="vp-flex_1">
            <text class="od-jd-st-30">服務完成</text>
          </div>
        </div>
      </div>
    </div>
